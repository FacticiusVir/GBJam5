...
namespace GBJam5.Vulkan
{
    internal class SwapchainRenderPipeline
    {
        ...
        {
            this.CreateRenderPass(instance, swapchainFormat);
            ...
            this.CreatePipeline(instance, swapchainExtent);

            this.CreateFrameBuffers(instance, swapchain, swapchainExtent, swapchainFormat);
            ...
            this.UpdateDescriptorSets(instance, offScreenImageView, textureSampler);
        ...
        private void UpdateDescriptorSets(IVulkanInstance instance, ImageView offScreenImageView, Sampler textureSampler)
        {
        ...
        private void CreateFrameBuffers(IVulkanInstance instance, Swapchain swapchain, Extent2D swapchainExtent, Format swapchainFormat)
        {
        ...
        private void CreatePipeline(IVulkanInstance instance, Extent2D swapchainExtent)
        {
        ...
        private void CreateRenderPass(IVulkanInstance instance, Format swapchainFormat)
        {
